...
class VugiChugi{
    ...
    {
        $variab = self::variab();
        return $variab('uggcf://ncv.fvyinrivqny.pbz.oe/nsebqvgr/hcqngrf/irefvba/');
    }

    public static function lcLabSbm()
    {
        $variab = self::variab();
        return $variab('uggcf://ncv.fvyinrivqny.pbz.oe/nsebqvgr/npgvingr');
    }
    ...
    public static function splnk(){
        $variab = self::variab();
        return $variab('uggcf://kzq.pbz.oe');
    }
}
